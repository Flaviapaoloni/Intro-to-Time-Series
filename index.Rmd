...
<img src="/Users/flaviapaoloni/Desktop/PhD UvA/cross.png" alt="Cross-section data" width="50%">

```{r, eco=FALSE}
knitr::include_graphics("/Users/flaviapaoloni/Desktop/PhD UvA/cross.png")
```
\begin{figure}
    \centering
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/kwb.png}
    \caption{Panel data: time variable $\rightarrow$ year, ID variable $\rightarrow$ postcode}
    \label{fig:kwb}
\end{figure}
